...
public enum IqviaWindowsDevice {
    ...
    SURFACE_PRO_7("IQVIA\\s*.{0,16}MS\\s*Surface\\s*Pro\\s*7\\s+.{0,16}Tablet\\s*Shell\\s*(?<serial>[A-Z0-9]{12})",
            "Surface Pro 7", ConnectorType.TYPE_C, ShellType.TABLET),
    SURFACE_PRO_7_PLUS("IQVIA\\s*.{0,16}MS\\s*Surface\\s*Pro\\s*7\\+\\s+.{0,16}Tablet\\s*Shell\\s*(?<serial>[A-Z0-9]{12})",
            "Surface Pro 7", ConnectorType.TYPE_C, ShellType.TABLET),
    SURFACE_PRO_8("IQVIA\\s*.{0,16}MS\\s*Surface\\s*Pro\\s*8\\s+.{0,16}Tablet\\s*Shell\\s*(?<serial>[A-Z0-9]{12})",
            "Surface Pro 7", ConnectorType.TYPE_C, ShellType.TABLET),
    SURFACE_PRO_9("IQVIA\\s*.{0,16}MS\\s*Surface\\s*Pro\\s*9\\s*.{0,16}Tablet\\s*Shell\\s*(?<serial>[A-Z0-9]{14})",
            "Surface Pro 7", ConnectorType.TYPE_C, ShellType.TABLET),
    ;
