...
public enum IqviaAndroidTablet {
    ...
    GALAXY_TAB_A("IQVIA\\s*Samsung\\s*Galaxy\\s*Tab\\s*A\\s+.{0,16}Tablet\\s*Shell\\s*(?<serial>[A-Z0-9]{11})",
            "Galaxy Tab A", ConnectorType.TYPE_C),
    GALAXY_TAB_A7("IQVIA\\s*Samsung\\s*Galaxy\\s*Tab\\s*A7\\s*.{0,16}Tablet\\s*Shell\\s*(?<serial>[A-Z0-9]{11})",
            "Galaxy Tab A7", ConnectorType.TYPE_C),
    GALAXY_TAB_A8("IQVIA\\s*Samsung\\s*Galaxy\\s*Tab\\s*A8\\s*.{0,16}Tablet\\s*Shell\\s*(?<serial>[A-Z0-9]{11})",
            "Galaxy Tab A8", ConnectorType.TYPE_C),
    GALAXY_TAB_S4("IQVIA\\s*Samsung\\s*Galaxy\\s*Tab\\s*S4\\s*.{0,16}Tablet\\s*Shell\\s*(?<serial>[A-Z0-9]{11})",
            "Galaxy Tab A8", ConnectorType.TYPE_C),
    ;
