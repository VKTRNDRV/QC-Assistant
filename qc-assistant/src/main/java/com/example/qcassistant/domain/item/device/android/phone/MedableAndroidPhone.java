...
public enum MedableAndroidPhone {
    ...
    MOTO_E32S("Medable\\s*Motorola\\s*Moto\\s*e32\\s*.{0,16}SmartPhone\\s*Shell\\s*(?<serial>[A-Z0-9]{10})",
    ...
    MOTO_E7("Medable\\s*Motorola\\s*Moto\\s*E7\\s*Power.{0,16}SmartPhone\\s*Shell\\s*(?<serial>[A-Z0-9]{10})",
            "Moto E7", ConnectorType.TYPE_C),
    MOTO_G_PRO("Medable\\s*Motorola\\s*Moto\\s*G\\s*Pro.{0,24}SmartPhone\\s*Shell\\s*(?<serial>[A-Z0-9]{10})",
            "Moto G Pro", ConnectorType.TYPE_C),
    MOTO_G_STYLUS("Medable\\s*Motorola\\s*Moto\\s*[gG]{1}\\s*Stylus.{0,24}SmartPhone\\s*Shell\\s*(?<serial>[A-Z0-9]{10})",
            "Moto G Stylus", ConnectorType.TYPE_C),
    MOTO_G22("Medable\\s*Motorola\\s*Moto\\s*g2.{0,24}SmartPhone\\s*Shell\\s*(?<serial>[A-Z0-9]{11})",
            "Moto G22", ConnectorType.TYPE_C),
    MOTO_G6("Medable\\s*Motorola\\s*Moto\\s*G6.{0,24}SmartPhone\\s*Shell\\s*(?<serial>[A-Z0-9]{10})",
            "Moto G6", ConnectorType.TYPE_C),
    MOTO_G7("Medable\\s*Motorola\\s*Moto\\s*G7.{0,32}SmartPhone\\s*Shell\\s*(?<serial>[A-Z0-9]{10})",
            "Moto G7", ConnectorType.TYPE_C),
    A_11("Medable\\s*Samsung\\s*Galaxy\\s*A11\\s*.{0,16}SmartPhone\\s*Shell\\s*(?<serial>[A-Z0-9]{11})",
            "Samsung A11", ConnectorType.TYPE_C),
    A_12("Medable\\s*Samsung\\s*.{0,16}A12\\s*.{0,16}SmartPhone\\s*Shell\\s*(?<serial>[A-Z0-9]{11})",
            "Samsung A12", ConnectorType.TYPE_C),
    A_13("Medable\\s*Samsung\\s*.{0,16}A13\\s*.{0,16}SmartPhone\\s*Shell\\s*(?<serial>[A-Z0-9]{11})",
