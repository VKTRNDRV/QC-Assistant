...
import com.example.qcassistant.domain.item.device.ios.iphone.MedableIPhone;
import com.example.qcassistant.domain.item.device.medical.MedableMedicalDevice;
import com.example.qcassistant.domain.item.device.medical.MedicalDevice;
...
import com.example.qcassistant.regex.MedableOrderInputRegex;
